...
public class Island {
	...
	{	
		...
		else if( flags[F_SANCHO]!=0 )
		{
			...
			if( answer== 0 )
			{
				...
				if( answer== 0 )
				{
					...
					n1 = ""; //RBP Ignored now GetTag( "" );
					n2 = ""; //RBP Ignored now GetTag( n1 );
					n3 = ""; //RBP Ignored now GetTag( n1+","+n2 );
		...
		else if( flags[F_SANCHO] == 2 )
		{
			...
			if( answer== 0 )
			{
				//RBP Ignored now DoInternetConversation( "http://verge-rpg.com/sully.txt" );
			}
			else if( answer == 1 )
			{
				//RBP Ignored now DoInternetConversation( "http://verge-rpg.com/song.txt" );
			}
			else
			{
